...
const Header = () => {
  return (
    <div className="flex flex-col items-center justify-center rounded-custom overflow-hidden h-[400px] w-full bg-center bg-[url('/src/Image/bg.jpeg')] bg-cover bg-no-repeat text-white p-4">
